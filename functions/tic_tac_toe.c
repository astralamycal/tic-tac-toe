...
void tic_tac_toe()
{
    ...
    char **boardValues = malloc(10 * sizeof(*boardValues)); // allocation of memory for board creation
    boardValues[8] = NULL;
    ...
    while (counter < 9) // handling of symbol placement
    {
        ...
        {
            printf("Please choose a number between 1 and 9."); // choosing between 1-9 is more logical than 0-8
            while (getchar() != '\n')
